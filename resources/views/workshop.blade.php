...
@section('content')
<div class="site-wrapper text-center jumbotron jumbo" style="color: white;">
    <div class="site-wrapper-inner">
        <div class="cover-container">
            <main role="main" class="inner cover">
                <h1 class="cover-heading">Workshop IT</h1>
                <br>
                <h3>Bingung Mau Mulai dari Mana?</h3>
                <br>
                <p class="lead">
                  <a class="btn btn-primary btn-lg" href="/kelas" role="button">Mulai dari Sini</a>
                </p>
            </main>
        </div>
    </div>
